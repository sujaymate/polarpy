...
polar = TimeSeriesBuilder.from_polar_spectrum(name='polar_spec', polar_events='/home/sujay/local/data/3ml-test/test_events_170114A.fits',
                                              polar_specrsp='/home/sujay/local/data/3ml-test/test_RMF_ARF_170114A.fits',
                                              input_format='fits',
                                               trigger_time=trigger_time)
...
polar_polarization_ts = TimeSeriesBuilder.from_polar_polarization(name='polar_pol', polar_events='/home/sujay/local/data/3ml-test/test_events_170114A.fits',
                                              polar_specrsp='/home/sujay/local/data/3ml-test/test_RMF_ARF_170114A.fits',
                                              polar_polrsp='/home/sujay/local/data/3ml-test/test_porsp_170114A.polrsp',
                                              input_format='fits',
                                               trigger_time=trigger_time)
